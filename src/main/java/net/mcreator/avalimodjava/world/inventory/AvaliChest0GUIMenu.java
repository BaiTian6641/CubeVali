...
package net.mcreator.avalimodjava.world.inventory;
...
import net.mcreator.avalimodjava.procedures.AvaliChest0GUICloseSoundProcedure;
...
public class AvaliChest0GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AvaliChest0GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(AvaliModJavaModMenus.AVALI_CHEST_0_GUI.get(), id);
	...
	public void removed(Player playerIn) {
		...
		AvaliChest0GUICloseSoundProcedure.execute(world, x, y, z);
