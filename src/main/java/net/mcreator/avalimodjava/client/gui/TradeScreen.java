...
public class TradeScreen extends AbstractContainerScreen<TradeMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("avali_mod_java:textures/screens/trade.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.avali_mod_java.trade.label_trade"), 73, 11, -12829636, false);
	}
